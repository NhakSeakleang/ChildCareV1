...
class SelectBabysitterView: UIView {
    ...
    var imgChild2: UIImageView = {
        let imgView = UIImageView()
        imgView.image = #imageLiteral(resourceName: "Babysitter3")
        imgView.contentMode = ContentMode.scaleAspectFill
        imgView.backgroundColor = .lightGray
        imgView.layer.cornerRadius = 50
        imgView.layer.borderColor = UIColor.gray.cgColor
    ...
    var imgChild3: UIImageView = {
        let imgView = UIImageView()
        imgView.image = #imageLiteral(resourceName: "Babysitter2")
        imgView.contentMode = ContentMode.scaleAspectFill
        imgView.backgroundColor = .lightGray
        imgView.layer.cornerRadius = 50
        imgView.layer.borderColor = UIColor.gray.cgColor
